...
interface MintRallyForwarderInterface extends ethers.utils.Interface {
  functions: {
...
export class MintRallyForwarder extends BaseContract {
  ...
  interface: MintRallyForwarderInterface;
